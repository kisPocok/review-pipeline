...
Group findings by severity. Use these EXACT severity headers (a downstream step parses them):
...
If you find no defects, output a single line: **No findings.** followed by one sentence on what you checked.
